        ...
        {data && (
          <>
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                <h1 className="font-serif text-2xl font-semibold text-ink sm:text-3xl">
                  {data.profile.display_name || "Traveler"}
                </h1>
                {data.profile.bio && (
                  <p className="mt-1 text-sm text-muted-foreground">{data.profile.bio}</p>
                )}
            ...
            <h2 className="mt-8 font-serif text-lg font-semibold text-ink">
              Shared drives ({data.routes.length})
            </h2>
            ...
            <div className="mt-8">
              <Link to="/community">
                <Button variant="outline">
                  <MapPin className="mr-2 h-4 w-4" /> More from the community
                </Button>
              </Link>
            </div>
          </>
